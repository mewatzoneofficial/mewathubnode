...
export const getAllRecords = async (req, res) => {
  try {
    ...
    const countQuery = `SELECT COUNT(*) AS total FROM admin_designation ${whereClause}`;
    ...
    return successResponse(res, "admin_designation fetched successfully", {
      page,
      limit,
      total,
